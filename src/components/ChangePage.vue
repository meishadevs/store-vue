...
<template>
  ...
  <div class="change-page" v-if="indexPage == 1">
    ...
    <span>1</span>
    <a href="javascript:;" v-for="page in createArrNum(2, totalPage)" :key="page" @click="changePage(page)">{{ page }}</a>
  ...
  <div class="change-page" v-else-if="indexPage === totalPage">
    ...
    <a href="javascript:;" v-for="page in createArrNum(1, totalPage)" :key="page" @click="changePage(page)">{{ page }}</a>
    <span>{{ totalPage }}</span>
  ...
  <div class="change-page" v-else>
    ...
    <a href="javascript:;" v-for="page in createArrNum(1, indexPage)" :key="page" @click="changePage(page)">{{ page }}</a>
    <span>{{ indexPage }}</span>
    <a href="javascript:;" v-for="page in createArrNum(indexPage + 1, totalPage - indexPage + 1)" :key="page" @click="changePage(page)">{{ page }}</a>
