  ...
  <div id="choose">
    ...
    <section class="wrapper clearfix">
      ...
      <div class="right-area">
        ...
        <select-show-product :curPage="curPage" :numProduct="numProduct"></select-show-product>
        <change-page :totalPage="totalPage" :curPage="curPage" v-if="totalPage > 0"></change-page>
      </div>
    </section>
    <div class="hr-40"></div>
    <site-foot></site-foot>
