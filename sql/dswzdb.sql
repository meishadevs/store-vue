...
(1, 'touxiang1.jpg', 'm***k', '金星会员', '还能再便宜点么？', '您好，现在已经是活动价格了。', '2017-05-11 18:39:00'),
(2, 'touxiang2.jpg', '世***8', '木星会员', '出售的商品是正品吗？', '您好，我们出售的所有商品均为正品，享受全国三包保修政策。', '2017-04-19 21:11:00'),
(3, 'touxiang3.jpg', 'xie***chao', '水星会员', '销售的商品都是统一包装吗？', '您好，我们发出的商品都是经过检验后精心包装，如在收到商品时发现包装有破损，请及时致电400-011-1366，客服人员会帮您解决。', '2017-05-18 09:51:00'),
(4, 'touxiang4.jpg', '祈***谧', '火星会员', '商品中的价格是否包含了运费？', '您好，订单金额大于100元，免邮费；订单金额不足100元，则您需要支付10元的物流费用，您在订单中可以看到您购买的物品的价格以及需要支付的物流费用。', '2017-05-14 11:53:00'),
(5, 'touxiang5.jpg', 'j***0', '土星会员', '如何查看商品都有哪些配件？', ' 您好，请点击商品页面的“包装清单”图标，这里会显示该产品包含的配件。', '2017-05-02 11:26:00'),
(6, 'touxiang6.jpg', 'm***m', '金星会员', '如何查看商品具体的规格参数？', '您好，请点击商品页面的“规格参数”图标，这里会显示该产品的具体参数。', '2017-04-21 10:30:00'),
(7, 'touxiang7.jpg', '希***哥', '木星会员', ' 购买商品是否有赠品？', '您好，如果商品页面有“赠品”字样与具体的赠品内容，这就表明该商品是有赠品的。您购买后，赠品就会连同商品一起寄送给您。如果商品页面没有显示“赠品”字样与具体的赠品内容，则表明该商品是没有赠品的。', '2017-05-13 20:12:00'),
(8, 'touxiang8.jpg', 'j***5', '水星会员', '某款商品有赠品，是否可以不要赠品，而以更低的价格购买该商品？', ' 您好，商城目前不支持这种购买方式，因为赠品与商品是配套销售的。', '2017-05-21 21:27:00'),
(9, 'touxiang9.jpg', '一***0', '火星会员', '款商品有赠品，如果不喜欢该赠品，是否可以要求更换为其他的赠品？', '您好，赠品与商品是配套的，目前不支持更换。', '2017-04-19 22:10:00'),
(10, 'touxiang10.jpg', '顾***微', '土星会员', '品加入购物车后，是不是该商品就已经被我预定了？', '您好，不是的。如果您想订购该商品，请把该商品加入购物车并进行结算，成功提交订单后是预定了该商品，支付后才算购买成功。', '2017-05-17 07:54:00'),
(11, 'touxiang11.jpg', 'a***k', '金星会员', '商品价格能不能再便宜一点？', '您好，商城所有商品都是严格按照商城标价进行销售的，不议价。', '2017-05-09 21:51:00'),
(12, 'touxiang12.jpg', '7***宏', '木星会员', '“下单立减”是什么意思？', '您好，您好，“下单立减”是促销活动。您下单后，商品价格会下调相应的金额。例如，某款商品标价1999，商品页面显示“下单立减300元”，您下单后，商品价格会下调300元，您只需支付1699元就可以购买该款产品了。', '2017-05-19 18:29:00'),
(13, 'touxiang13.jpg', 'k***1', '水星会员', '如何找回账户密码？', '  您好，如果您忘记了密码，商城为您提供了找回密码的服务。请在忘记密码的页面中输入您的商城账号，并按照网页提示进行操作，便可找回您的密码。', '2017-05-13 14:23:00'),
(14, 'touxiang14.jpg', 'j***6', '火星会员', '在下了订单后如何得知是否发货？', ' 您可以在“订单查询”中的订单详细列表内查看，一旦您订购的商品状态发生变化都会即时显示，同时，您也可以点击物流运单号，跟踪查看当前的物流状态。', '2017-05-11 15:20:00'),
(15, 'touxiang15.jpg', 'j***c', '土星会员', '购买商品都有发票吗？', '您好，我们商城出售的商品都有正规发票。', '2017-05-13 08:04:00'),
(16, 'touxiang16.jpg', 'j***e', '金星会员', '会在发货的同时配送发票给用户吗？', '您好，您购买的商品商城统一提供国家税务局监制的正规发票。此发票可用作单位报销凭证，发票会跟您所选购的商品一起寄给您。', '2017-03-28 06:27:00'),
(17, 'touxiang17.jpg', '伤***泣', '木星会员', '如何开具增值税专用发票？', '您好，我们目前不支持开具增值税专用发票。', '2017-05-15 00:00:00'),
(18, 'touxiang18.jpg', '汪***l', '水星会员', '退货时是否需要将发票退回？', '办理退换货需要连同发票一起退回，如果没有发票则无法办理，请谅解。', '2017-05-20 14:07:00'),
(19, 'touxiang19.jpg', '弓***我', '火星会员', '一张订单购买多台机器，商城开具几张发票？', '您好，一张订单只开具一张发票。', '2017-05-09 20:11:00'),
(20, 'touxiang20.jpg', 'j***d', '土星会员', '你们提供哪些售后服务？', '您好，商城将严格按照国家三包法规，针对产品履行修理、更换和退货的责任和义务。自购买之日起7日内，且经过360手机授权维修机构鉴定的，附检测单可以进行退货。自购买之8-15天内的性能故障的，附检测单可以进行换货。', '2017-05-08 22:53:00'),
(21, 'touxiang21.jpg', '半***悸', '金星会员', '购买的商品是否可以享受三包服务？', '您好，我们所售商品均为正品行货且有正规发票，您可凭发票与保修卡在我们授权的售后服务中心享受全国联保服务，我们将严格按照国家三包政策为您提供三包服务。', '2017-05-19 16:35:00'),
(22, 'touxiang22.jpg', 'j***w', '木星会员', '买的商品可以享受哪些售后服务？', '商城将严格按照国家三包法规，针对产品履行修理、更换和退货的责任和义务。自购买之日起7日内，且经过我们授权维修机构鉴定的，附检测单可以进行退货。自购买之8-15天内的性能故障的，附检测单可以进行换货。', '2017-05-15 22:32:00'),
(23, 'touxiang23.jpg', 'i***a', '水星会员', '三包日期从何时算起？', '您好， 三包日期从您签收商品之日开始计算，签收日为第1天。', '2017-04-27 00:01:00'),
(24, 'touxiang24.jpg', ' 韩***明', '火星会员', '你们授权的售后服务网点在哪里可以查到？', '您好，您可在我们的官方网站“ 售后网点查询”处进行查询，您也可查看产品保修卡或拨打奇酷客服热线400-888-1388转2进行查询', '2017-05-10 16:15:00'),
(25, 'touxiang25.jpg', '华***s', '土星会员', '商城商品是如何配送的，使用的是什么快递？可以自行选择不同的物流公司吗？', '我们采用顺丰和宅急送优质快递服务，可实现全国覆盖，为您提供服务更优、速度更快的物流配送服务。暂不支持自选物流公司。', '2017-04-23 11:28:00'),
(26, 'touxiang26.jpg', 'j***0', '金星会员', '订单支付成功后，商城何时开始发货？', '您好，在商品现货的情况下，我们会在您支付成功后的3天内为您发货。抢购、促销活动时依当时活动规则来定。', '2017-05-12 10:08:00'),
(27, 'touxiang27.jpg', '1***p', '木星会员', '商品发货后，一般几天可以送到？', '您好，顺丰速运配送，广东省内地区一般1-2天可以送到，广东省外（新疆、西藏、内蒙等偏远地区除外）一般3到7天可以送到。宅急送配送，一般2到7天左右可以送到。', '2017-05-05 15:17:00'),
(28, 'touxiang28.jpg', '户***杰', '水星会员', '商城一般是从哪里发货的？', '我们的商品从东莞，深圳，北京三个地点发货。', '2017-04-16 21:37:00'),
(29, 'touxiang29.jpg', 'j***1', '火星会员', '商城可以指定送货时间吗？', '您好，目前我们仅可以选择工作日或非工作日送货，配送人员在配送前电话联系您的时候，您可以与配送员协商您的需求，配送人员会尽量为您安排。', '2017-05-12 11:55:00'),
(30, 'touxiang30.jpg', '我***哒', '土星会员', '你们的支付方式有哪几种？', '您好，商城目前仅支持在线支持，包括网银、信用卡、支付宝、微信扫码支付。', '2017-05-04 18:47:00');
